      ...
      <PageContainer>
        <div className={styles.contentPage}>
          ...
          <p>
            ...
            ("YOU,""YOUR" OR "YOURSELF") AND Quraniclove.com ("OUR,""US,""WE" OR "
            Quraniclove.com"), WHICH GOVERNS YOUR USE OF OUR MOBILE APPLICATIONS, WEBSITES AND ALL
            INTERNET-BASED SERVICE TOGETHER WITH ALL INFORMATION, CONTENT, PRODUCTS, MATERIALS AND
            SERVICES MADE AVAILABLE TO YOU THROUGH THE SAME BY US AND/OR THIRD PARTIES
            (COLLECTIVELY,"THE SERVICE").
          </p>
          <p>
            PLEASE READ THIS AGREEMENT CAREFULLY BEFORE USING THE SERVICE. BY CLICKING THE "ACCEPT"
            BUTTON, DOWNLOADING OR USING THE Quraniclove.com MOBILE APPLICATION, (THE "MOBILE
          ...
          <p>
            ...
            YOU MAY NOT USE THE Quraniclove.com MOBILE APPLICATION TO WHICH THIS AGREEMENT APPLIES.
            Quraniclove.com is provided and managed by Quran Foundation, Inc. Anytime
            Quraniclove.com is mentioned it is also referring to Quran Foundation, Inc.
          </p>
          <h2>0. GENERAL</h2>
          <p>
            0.1 Quraniclove.com HAS A 0 TOLERANCE POLICY FOR ABUSIVE, SEXUAL, OR QUESTIONABLE
            CONTENT. ABUSIVE USERS OR USERS WHO POST SAID CONTENT WILL BE PERMANENTLY BANNED.
          </p>
          <p>
            0.2 The opinions and ideas expressed by users are solely their own and do not
            necessarily reflect the views of Quraniclove.com or Quran Foundation, Inc.
          </p>
          <p>
          ...
          <p>
            1.1 The Service shall include, without limitation (i) the Quraniclove.com Mobile
            Application, together with various other Quraniclove.com powered mobile applications and
            certain third-party integrated mobile device software applications, and including any
            software code, scripts, interfaces, graphics, displays, text, documentation and other
            components; (ii) any updates, modifications or enhancements to the items listed in
            subsection (i); and (iii) any of the Internet-based, interactive information services,
            general and personalized content, and interactive tools provided by Quraniclove.com that
            may be used or accessible by means of the Mobile Application or via our websites.
          </p>
          <p>
            1.2 The Mobile Application, is licensed, not sold, to you by Quraniclove.com. Your use
            of the Mobile Application must be made in strictly in accordance with this Agreement and
            the applicable usage rules established by any third party mobile device platform or
            service provider or the third party from whom you are downloading the Mobile Application
            (as defined in section 1.2) that relate to your Mobile Device (as defined in section
            2.1) ("Usage Rules"), which are incorporated herein by reference. Certain Usage Rules
            are described in Section 22 of this Agreement, however, it is your responsibility to
          ...
          <p>
            ...
            include those found at http://Quraniclove.com, without limitation.
          </p>
          <p>
          ...
          <p>
            2.1 Quraniclove.com grants You a revocable, non-exclusive, non-transferrable, limited
            right to install and use the Mobile Application on a single mobile telephone or device
            controlled by you (each a "Mobile Device"), and to access and use the Service on such
            Mobile Device or via our websites strictly in accordance with the terms and conditions
            of this Agreement.
          </p>
          <p>
            ...
            Quraniclove.com or its affiliates, partners, suppliers or the licensors of the Service
            or otherwise obscure or modify the any manner in which the Service is displayed by means
            of the Mobile Application or our websites; (v) install, use or permit the Mobile
            ...
            Quraniclove.com) other than one authorized pursuant to this Agreement; (ix) use the
            Service to send automated queries or to send any unsolicited commercial e-mail; (x) use
            the Service to attempt to interfere with the proper functioning and display of the
            proper operation and usage of the Service or our websites by any other authorized users
            and third parties; or (xi) use any proprietary information or interfaces of the Service
            or other intellectual property for any reason.
          </p>
          <p>
            ...
            that Quraniclove.com and its affiliates and their respective employees are expressly
            permitted to use the Service for the internal business purposes of Quraniclove.com and
            its affiliates). By using the Service, you agree you will not copy, reproduce, alter,
            modify, create derivative works from, rent, lease, loan, sell, distribute or publicly
            display any of the Content (except for your own personal, non commercial use) accessed
            by the Service without the prior written consent of Quraniclove.com. In addition, you
            will not use the Content for any unauthorized non-commercial marketing and promotional
            campaigns, target or mass solicitation campaigns or political campaigning. YOU
            ACKNOWLEDGE THAT YOUR USE OF THE SERVICE TO ENABLE THE TRANSMISSION OF UNSOLICITED VOICE
            MESSAGES, FACSIMILES OR EMAILS IS IN VIOLATION OF THIS AGREEMENT AND MAY BE IN VIOLATION
            OF UNITED FEDERAL AND STATE LAWS AND REGULATIONS.
          </p>
          <p>
            2.4 Some or all of the Service may be provided by an affiliate or subsidiary of
            Quraniclove.com or a third party, and you may be subject to both this Agreement and the
            terms of service of that third party. Certain portions of the Service may utilize or
            include third party software that is subject to open source and third party license
            terms ("Third Party Software"). You acknowledge and agree that your right to use such
            Third Party Software as part of, or in connection with, any Mobile Application or the
            internet is subject to and governed by the terms and conditions of the open source or
            ...
            therein. In the event of a conflict between the terms of this Agreement and the terms of
            such open source or third party licenses with regard to your use of the relevant Third
            Party Software, the terms of the open source or third party licenses shall control. In
            no event shall the Service or components thereof be deemed to be "open source" or
            "publicly available" software.
          </p>
          <p>
            2.5 Quraniclove.com does not warrant that the Service will be compatible or
            interoperable with your Mobile Device or any other piece of hardware, software,
            equipment or device installed on or used in connection with your Mobile Device or used
            to otherwise access our websites. You acknowledge and agree that Quraniclove.com and its
            affiliates, partners, suppliers and licensors shall have no liability to you for any
          ...
          <p>
            ...
            relating to your use of the Service, and agree to notify Quraniclove.com of any third
            party claims relating to the Service of which you become aware. Furthermore, you hereby
            release Quraniclove.com from any liability resulting from your use of the Service,
            including, without limitation, the following: (i) any product liability claims; (ii) any
            claim that the Service fails to conform to any applicable legal or regulatory
            requirement; and (iii) any claim arising under consumer protection or similar
            legislation.
          </p>
          <p>
          ...
          <p>
            2.8 You acknowledge that Quraniclove.com may from time to time issue upgraded versions
            of the Service, and may automatically electronically upgrade the version of the Mobile
          ...
          <p>
            ...
            as otherwise noted, Quraniclove.com does not charge for the use of Service, but carrier
            rates for phone, internet, data and text messaging may apply and you are responsible for
            any such charges, as well as, internet and pay any service fees associated with such
            access. In addition, you must provide all equipment necessary to make such connection to
            the internet and to be able to access our websites.
          </p>
          <p>
            ...
            Service. Quraniclove.com makes no warranty with respect to the accuracy of Service
            provided to you in reliance on location and geopositional data provided by you, the
            Mobile Application or via your Mobile Device or our websites.
          </p>
          <p>
          ...
          <p>
            3.4 You may be required to register and create an account ("Account") with
            Quraniclove.com in order to use the Mobile Application and certain features of the
            Service. Information gathered through the registration process and information related
            to your account will be subject to this Agreement, as well as to our Privacy Policy. You
            represent and warrant that all information provided by you when creating an Account is
            true, accurate and complete and that you will maintain, at all times, true, accurate and
            complete information related to your Account. You are prohibited from utilizing
            alter-egos or other disguised identities when utilizing the Service. You will promptly
            update your registration to keep it accurate, current and complete. If we issue you a
            username and password, you may not reveal it to anyone else. You may not use anyone
            else's username and/or password or allow anyone else to use your username and password
            to access the Service. You are responsible for maintaining the confidentiality of your
            Account, username and password, and for any charges, damages, liabilities or losses
            incurred or suffered as a result of your failure to do so. We are not liable for any
            harm caused by or related to the theft of your username and/or password, your disclosure
            of your username and/or password, or your authorization to allow another person to
            access and use the Service using your username and/or password. Furthermore, you are
            solely and entirely responsible for any and all activities that occur under your Account
            including any charges incurred relating to the Service. You agree to immediately notify
            us of any unauthorized use of your username, password or Account or any other breach of
            security. We will not be responsible for any loss or damage that may result if you fail
            to comply with these requirements. If you choose a username that, in our sole
            discretion, is obscene, indecent, abusive or which might otherwise subject us to public
            disparagement or scorn, we reserve the right, without prior notice to you, to
            automatically change your username, delete your submissions and/or posts from the
            Service, deny you access to the Service, or any combination of these options.
          </p>
          <p>
            3.5 You are under no obligation to use or continue to use the Service and may
            temporarily or permanently cease use of the Service without notice to Quraniclove.com.
          </p>
          ...
          <p>
            ...
            even if such information is not collected by Quraniclove.com. It is your responsibility
            to maintain the security of your Mobile Device or other device (i.e. home computer) from
            unauthorized access.
          </p>
          <p>
            4.2 Use of any personal information or other information about you collected by
            Quraniclove.com through, or in connection with, the Service is subject to our Privacy
            Policy, which Privacy Policy is incorporated into this Agreement by this reference.
          </p>
          <p>
            ...
            Quraniclove.com does not knowingly collect personal information from children through
            the Service; for questions about our online Privacy Policy for children you can find our
          ...
          <p>
            ...
            Service, (iv) the Quraniclove.com company names, logos, and all related products and
            service names, design marks and slogans, and (v) any and all copyrights, patents,
            trademarks, trade secrets, publicity rights and other intellectual property rights
            associated therewith (collectively, the "Intellectual Property,"), are the sole property
            of Quraniclove.com, its wholly-owned subsidiaries, affiliates, licensors, suppliers or
            other third parties. Except as expressly and unambiguously provided herein, you do not
            possess, and Quraniclove.com does not grant to you, any express or implied rights
            (whether by implication, estoppel or other legal theory) in or to any Intellectual
            Property (or the unauthorized use of the Intellectual Property) and all such rights are
            retained by Quraniclove.com, its subsidiaries, parent companies, affiliates and/or any
            third party owner of such rights. You acknowledge and agree that you, and not
            Quraniclove.com or any third party mobile device platform or service provider, shall be
            solely responsible for the investigation, defense, settlement and discharge of any
            intellectual property infringement claim or suit, or any other harm or damages resulting
            from your use of or access to the Service.
          </p>
          <h2>6. CONTENT LICENSE FROM YOU.</h2>
          <p>
            6.1 Quraniclove.com may, but is not obligated to, offer interactive features that allow
            users to, among other things, submit or post content ("User Generated Content") or links
            to third party content on areas of the Service accessible and viewable by other users of
            ...
            Service, you hereby grant to Quraniclove.com a limited license to use, modify, delete
            from, add to, publicly perform, publicly display, reproduce, and distribute such User
            ...
            discretion without notice or liability. Quraniclove.com has the right, but not the
            obligation, to monitor any information and User Generated Content submitted or posted by
            you or otherwise available on the Service, to investigate any reported or apparent
            violation of this Agreement, and to take any action that Quraniclove.com in its sole
            discretion deems appropriate. You acknowledge and agree that any User Generated Content
            provided by you shall be made public. You acknowledge that (i) you have no expectation
            of privacy in any User Generated Content, and (ii) no confidential, fiduciary,
            contractually implied or other relationship is created between you and Quraniclove.com
            by reason of your transmitting User Generated Content to any area of the Service.
          </p>
          ...
          <p>
            ...
            the Service. Quraniclove.com may not have knowledge of, and is not responsible for, the
            content, information, services, products or advertisements presented by any Other Site
            which you use at your own risk. Quraniclove.com does not warrant or make any
            representation regarding the legality, accuracy, quality or authenticity of content,
            information, services or products presented by Other Sites. The hyperlinks to Other
            Sites do not constitute an endorsement by Quraniclove.com of any Other Site(s) or
            resources, or their content, information, services or products. The Service is only
            providing these links to you as a convenience. The terms of use and privacy policy of
            any Other Sites shall apply to your access and use of them. Quraniclove.com accepts no
            responsibility for the content or conduct of Other Sites
          </p>
          <p>
            7.3 Quraniclove.com makes no representations whatsoever concerning (1) the information,
            ...
            Content Provider Service or Other Sites. Quraniclove.com shall not be responsible or
            liable, directly or indirectly, for any damage or loss caused or alleged to be caused
            by, or in connection with your use of Third Party Provider Content and Services or Other
            Sites or your reliance on any such Third Party Content Provider content, goods or
            services, available on or through any Third Party Provider Content and Services or Other
            Sites.
          </p>
          ...
          <p>
            8.4 Quraniclove.com makes no representation that any third party mobile device platform
            or service provider has endorsed the Service, and you should not rely on the
            availability of the Mobile Application by means of any mobile application catalog,
            storefront, or other means of downloading as an endorsement of the Mobile Application,
            the Service or Quraniclove.com generally. In no event shall any third party mobile
            device platform or service provider have any obligation to you whatsoever to furnish any
          ...
          <p>
            ...
            provided via a third party’s player and is hosted on a third party’s servers;
            Quraniclove.com does not have the ability to permanently remove all or any such content
            from the third party’s servers. Therefore, if you have a complaint concerning any video
            content made available on the Service that is provided by a third party, you should
            contact the third party directly in accordance with copyright policies of the third
            party. If you believe that your work is available on the Service via a third party
            player in a way that constitutes copyright infringement, please: (1) contact the third
            party directly in accordance with its copyright policies; and (2) contact
            Quraniclove.com by sending us notice in accordance with Section 15, below
          </p>
          <h2>10. Quraniclove.com DISCLOSURES</h2>
          <p>
          ...
          <p>
            ...
            material connection between Quraniclove.com and the providers of the products and
            services displayed. It should be noted that this is not always the case.
          </p>
          <p>
            10.3 Quraniclove.com will always recommend products and services based in part on a good
            faith belief that the supply of such products or services will help you. We have a good
            faith belief, because Quraniclove.com has either tried the products or services prior to
            making any recommendations, or we have researched the products or services based on the
            supplier’s history. The recommendations made by Quraniclove.com about the products or
            services are honest opinions based on facts known to us at the time a product or service
            is mentioned on the Service.
          </p>
          <p>
            10.4 We have conducted all steps possible to verify the testimonials that appear on the
            Service on behalf of Quraniclove.com. They are treated as average user expectations
            based on the information that was available at the time of publishing them. They are not
          ...
          <p>
            ...
            and any use of the Internet generally shall be at your sole risk. Quraniclove.com
            disclaims any and all responsibility or liability for the accuracy, content,
            completeness, legality, licensure of Third Party Content Providers, reliability, or
            operability or availability of information or the Content accessible by use of the
            Service.
          </p>
          <p>
            ...
            Quraniclove.com DISCLAIMS, TO THE FULLEST EXTENT PERMITTED UNDER LAW, ANY WARRANTIES
            REGARDING THE SECURITY, RELIABILITY, TIMELINESS, ACCURACY AND PERFORMANCE OF THE MOBILE
            APPLICATION, OUR WEBSITES, THE SERVICE AND ANY CONTENT. Quraniclove.com DOES NOT WARRANT
            THAT ANY DEFECTS OR ERRORS WILL BE CORRECTED; OR THAT THE MOBILE APPLICATION, OUR
            WEBSITES, THE SERVICE, ANY CONTENT, OR THE INTERNET GENERALLY, IS FREE OF VIRUSES,
            ERRORS, OTHER HARMFUL COMPONENTS, OR WILL BE UNINTERRUPTED.
          </p>
          <p>
            11.3 Quraniclove.com DISCLAIMS, TO THE FULLEST EXTENT PERMITTED UNDER LAW, ANY AND ALL
          ...
          <p>
            11.4 NO ADVICE OR INFORMATION PROVIDED BY Quraniclove.com, ITS AFFILIATES, OR THEIR
            RESPECTIVE EMPLOYEES AND AGENTS SHALL CREATE ANY WARRANTY.
          </p>
          <p>
            11.5 NONE OF Quraniclove.com, ITS AFFILIATES, OR ANY ASSOCIATED MOBILE DEVICE PLATFORM
            AND SERVICE PROVIDERS, MAKE ANY REPRESENTATIONS, WARRANTIES OR GUARANTEES REGARDING (1)
            THE OPERATION OR PERFORMANCE OF THE MOBILE APPLICATION, SERVICE, OR ANY THIRD PARTY
            PROVIDER CONTENT OR SERVICES OR OTHER SITES; (2) THE NATURE, CONTENT OR ACCURACY (EITHER
            WHEN ACCESSED OR AS A RESULT OF THE PASSAGE OF TIME) OF ANY INFORMATION, MATERIAL,
            APPARATUS OR OTHER PROCESS CONTAINED ON, DISTRIBUTED THROUGH, OR LINKED, DOWNLOADED OR
            ACCESSED FROM THE MOBILE APPLICATION OR OUR WEBSITES (INCLUDING WITHOUT LIMITATION,
            THOSE ACCESSED USING THIRD PARTY PROVIDER CONTENT OR SERVICES); (3) ANY PRODUCTS OR
            SERVICES PURCHASED THROUGH USE OF ANY THIRD PARTY PROVIDER CONTENT OR SERVICE OR OTHER
            SITE, OR ANY PRODUCTS OR SERVICES PURCHASED OR OBTAINED AS A RESULT OF AN ADVERTISEMENT
            OR OTHER INFORMATION OR MATERIAL IN CONNECTION WITH ANY MOBILE APPLICATION, WEBSITE; OR
            (4) THE INTERNET GENERALLY.
          </p>
          <p>
          ...
          <p>
            11.7 NEITHER Quraniclove.com, NOR ANY OF ITS ASSOCIATED MOBILE DEVICE PLATFORM AND
            SERVICE PROVIDERS, WARRANTS THAT THE MOBILE APPLICATION WILL BE COMPATIBLE OR
            INTEROPERABLE WITH YOUR MOBILE DEVICE OR ANY OTHER PIECE OF HARDWARE, SOFTWARE,
            EQUIPMENT OR DEVICE INSTALLED ON OR USED IN CONNECTION WITH YOUR MOBILE DEVICE.
            FURTHERMORE, YOU ACKNOWLEDGE THAT COMPATIBILITY AND INTEROPERABILITY PROBLEMS CAN CAUSE
            THE PERFORMANCE OF YOUR MOBILE DEVICE TO DIMINISH OR FAIL COMPLETELY, AND MAY RESULT IN
            PERMANENT THE DAMAGE TO YOUR MOBILE DEVICE, LOSS OF THE DATA LOCATED ON YOUR MOBILE
            DEVICE, AND CORRUPTION OF THE SOFTWARE AND FILES LOCATED ON YOUR MOBILE DEVICE. YOU
            ACKNOWLEDGE AND AGREE THAT Quraniclove.com AND ITS AFFILIATES, PARTNERS, SUPPLIERS,
            LICENSORS, AND ASSOCIATED MOBILE DEVICE PLATFORM AND SERVICE PROVIDERS SHALL HAVE NO
            LIABILITY TO YOU FOR ANY LOSSES SUFFERED RESULTING FROM OR ARISING IN CONNECTION WITH
            COMPATIBILITY OR INTEROPERABILITY PROBLEMS.
          </p>
          <h2>12. LIMITATION OF LIABILITY.</h2>
          <p>
            12.1 IN NO EVENT SHALL Quraniclove.com OR ANY OF ITS ASSOCIATED MOBILE DEVICE PLATFORM
            AND SERVICE PROVIDERS BE LIABLE TO YOUR FOR YOUR USE, MISUSE OR RELIANCE ON THE MOBILE
            ...
            PROPERTY INFRINGEMENT, TORT (INCLUDING NEGLIGENCE) OR OTHER THEORY, EVEN IF
            Quraniclove.com OR ANY OF ITS ASSOCIATED MOBILE DEVICE PLATFORM AND SERVICE PROVIDERS
            ARE AWARE OF OR HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGE, ARISING OUT OF OR
            CONNECTED WITH (1) THE USE (OR INABILITY TO USE) OR PERFORMANCE OF THE SERVICE, (2) THE
            CONTENT OR THE INTERNET GENERALLY, (3) RELIANCE UPON OR PERFORMANCE OF ANY CONTENT
            CONTAINED IN OR ACCESSED FROM ANY MOBILE APPLICATION OR ANY THIRD PARTY PROVIDER CONTENT
            OR SERVICES OR OTHER SITES, OR (4) ANY PRODUCTS OR SERVICES PURCHASED OR OBTAINED AS A
            RESULT OF AN ADVERTISEMENT OR OTHER INFORMATION OR MATERIAL ACCESSED USING THE MOBILE
            APPLICATION,OUR WEBSITE OR THE SERVICE. NEITHER Quraniclove.com, NOR ANY OF ITS
            ASSOCIATED MOBILE DEVICE PLATFORM OR SERVICE PROVIDERS, ASSUMES ANY LEGAL LIABILITY OR
            RESPONSIBILITY FOR THE ACCURACY, COMPLETENESS, TIMELINESS OR USEFULNESS OF ANY
            INFORMATION, APPARATUS, PRODUCT OR PROCESS OR OTHER MATERIAL ACCESSIBLE FROM THE MOBILE
            APPLICATION. THE USER OF THE SERVICES ASSUMES ALL RESPONSIBILITY AND RISK FOR THE USE OF
          ...
          <p>
            12.4 WITHOUT LIMITING THE GENERALITY OF THE FOREGOING, Quraniclove.com'S AGGREGATE
            LIABILITY TO YOU (WHETHER UNDER CONTRACT, TORT, STATUTE OR OTHERWISE) SHALL NOT EXCEED
            THE AMOUNT OF FIFTY DOLLARS ($50.00).
          </p>
          <h2>13. INDEMNIFICATION.</h2>
          <p>
            13.1 You agree to indemnify and hold Quraniclove.com and, as applicable, our parent,
            ...
            agreement with Quraniclove.com on the basis of this Agreement); (ii) your use or misuse
            of any location information; (iii) any information, User Generated Content or other
            content transmitted, submitted or provided by you through the Service, including your
            use of the Service to provide a link to another website or to upload content or other
            information using the Mobile Application or our websites and, without limitation, our
            exercise of our rights with respect to such information; (iv) your violation of any law,
            or your violation of the rights of a third party, including the infringement by you of
            any intellectual property, and (v) your use of any User Generated or Third Party
          ...
          <p>
            13.3 Quraniclove.com reserves the right, at its own expense, to assume the exclusive
            defense and control of any matter subject to indemnification by you, which will not
            excuse your indemnity obligations under this Section. You agree not to settle any matter
            subject to the forgoing indemnification obligations without the express consent and
            approval of Quraniclove.com.
          </p>
          <h2>14. DIGITAL MILLENNIUM COPYRIGHT COMPLAINTS.</h2>
          <p>
            Quraniclove.com respects the copyright rights of others, and we ask user of Service, our
          ...
          <p>
            ...
            UNDER DMCA AND WE DO NOT REPRESENT ANY RELATED UNDERTAKING BY Quraniclove.com NOT
            OTHERWISE EXPRESSLY REQUIRED BY APPLICABLE LAW.
          </p>
          <h2>15. TERMINATION.</h2>
          <p>
            Quraniclove.com may, in its sole and absolute discretion, at any time and for any or no
            ...
            without any notice or other action by Quraniclove.com. Upon the termination, you shall
            cease all use of the Service and/or uninstall the Mobile Application from your Mobile
            Device. Quraniclove.com reserves the right to terminate or disable all or any portion of
            the Service, our websites or of the Mobile Application (via update of the Mobile
            Application).
          </p>
          <h2>16. REMEDIES AVAILABLE TO US.</h2>
          <p>
            Quraniclove.com reserves the right to seek any and all remedies available at law or in
            equity in connection with your violation of this Agreement.
          </p>
          <h2>17. ASSIGNMENT.</h2>
          <p>
          ...
          <p>
            You acknowledge and agree that it is the intent of both you and Quraniclove.com to limit
            the period of time a claim may be filed, even if the period is shorter than that fixed
            by the statute of limitations. You therefore agree that any cause of action arising out
            of or related to the Service must commence within one (1) year after the cause of action
          ...
          <p>
            ...
            between you and Quraniclove.com with respect to your use of the Service, and it
            supersedes and replaces all prior or contemporaneous communications, proposals,
            understandings or agreement, whether electronic, oral or written, between you and
            Quraniclove.com with respect to your use of the Service and/or the subject matter of
            Agreement.
          </p>
          <p>
            ...
            acknowledge and agree that each of Quraniclove.com's associated mobile device platform
            and service providers are third party beneficiaries to this Agreement, and that, upon
            your acceptance of the terms and conditions of this Agreement, such associated mobile
            device platform and service providers will have the right to enforce this Agreement
            against you in its capacity as a third party beneficiary to this Agreement.
          </p>
          <p>
            20.5 Any waiver of any provision of this Agreement will be effective only if in writing
            and signed by you and Quraniclove.com. Our failure to enforce our rights and remedies
          ...
          <p>
            20.6 To be removed from future Quraniclove.com marketing e-mail campaigns, please e-mail
          ...
          <p>
            Quraniclove.com reserves the right to add, delete, change or modify parts of this
            Agreement at our sole discretion and at any time without notice or liability to you. If
            we do this, we will post the changes on this page and will indicate the effective date
            of the change at the bottom of the page. It is important for you to refer to this
            Agreement from time to time to make sure that you are aware of any additions, revisions,
            or modifications that we may have made. Your continued use of the Service constitutes
