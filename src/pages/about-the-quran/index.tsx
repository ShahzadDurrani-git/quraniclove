      ...
      <PageContainer>
        <div className={styles.contentPage} dir="ltr">
          <div className={styles.section}>
            ...
            <div>
              We welcome you to Quraniclove.com and invite you to read and listen to the Quran with
              an open heart, to deeply contemplate its verses, sincerely seek the knowledge
              contained within it, and to learn more using the resources on our site. We hope you
              will find Quranicove.com beneficial and pray that the message of the Quran will enrich
              your life’s journey.
            </div>
          </div>
          <div className={styles.section}>
          ...
          <div className={styles.section}>
            <h1>How can Quraniclove.com help me on my Quran journey?</h1>
            <div>
              Quraniclove.com is a comprehensive online platform that provides a range of features
              to help people explore and engage with the Quran.
            </div>
            <div>
            ...
            <div>
              Another feature of Quraniclove.com is the Reflections section, which provides a space
              for readers to engage with the Quranic text on a more personal level. This feature
            ...
            <div>
              For those who prefer to listen to the recitation of the Quran, Quraniclove.com offers
              a diverse library of Quranic recitations by renowned{' '}
            ...
            <div>
              To further aid users in their understanding of the Quranic text, Quraniclove.com
              provides word-by-word translations and audio, as well as a word tooltip feature that
              provides translations of individual words in the text. This makes the Quranic text
              more accessible and understandable to readers who are still learning the Arabic
              language.
            </div>
            <div>
              Additionally, Quraniclove.com offers{' '}
