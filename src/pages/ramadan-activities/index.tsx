      ...
      <PageContainer>
        ...
        <div className={classNames(pageStyles.container, styles.contentPage)} dir="ltr">
          <div className={styles.subSection} id="mindful">
            ...
            <ReadMoreCollapsible section={Section.MINDFUL_FASTING}>
              <div>
                ...
                to read reflections from the community. (If you already have a Quraniclove.com
                account - signing in to QuranReflect with the same email will link the two
                accounts.)
              </div>
            </ReadMoreCollapsible>
          ...
          <div className={styles.subSection}>
            <h1>Learning Plans on Quraniclove.com 📖</h1>
            <div>
          ...
          <div className={styles.subSection}>
            ...
            <div>
              ...
              to Quraniclove.com and begin reading to start your Streak! You can also create a
              custom goal that will help you stay on track:
            </div>
            <div className={styles.ctaContainer}>
              <Button
                onClick={() => {
